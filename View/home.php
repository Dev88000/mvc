                ...
                <div class="card bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text text-dark text-end">            
                            <button type="button" class="btn"><i class="fa-solid fa-comment text-info" data-bs-target="#menu_avis" data-bs-toggle="modal"></i></button>                   
                        </p>
                    </div>
                </div>
            </div>
...
<!-- Avis -->
<!-- Modal avis sur l'affichage projet-->
<div class="modal fade" id="menu_avis" aria-hidden="true" aria-labelledby="menu_avis_Label" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="menu_avis_Label">Commentaires</h1>
                <?php if (isset($_SESSION['prenom'])) { ?>
                <button type="button" class="btn"><i class="fa-solid fa-comment text-info" data-bs-target="#creation_avis" data-bs-toggle="modal"></i></button>  
                <?php } ?>
            </div>
            <div class="modal-body">
